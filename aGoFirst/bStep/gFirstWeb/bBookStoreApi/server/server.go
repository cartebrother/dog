...
import (
	"encoding/json"
	"github.com/dog/bBookStoreApi/server/middleware"
...
func NewBookStoreServer(addr string, s store.Store) {
	srv := &BookStoreServer{
		s:   s,
	...
	srv.src.Handler = middleware.Logging(middleware.Validating(router))
	return srv
